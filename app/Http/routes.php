...
/******************************************************************************************************************************/
/*shipping*/
Route::get('/web88cms/shipping_method/{type?}', ['uses' => 'Admin\ShippingMethodsController@index', 'as' => 'ship.index']);
...
Route::get('/web88cms/usergroups/{item}/{page}', 'Admin\UsergroupController@index');
