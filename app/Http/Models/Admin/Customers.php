...
class Customers extends Model{
	...
	{
		return DB::table('orders')->where('customer_id', $customer_id)->orderBy('createdate', 'DESC')->get();
	}
	...
	public function getCustomerWishlist($customer_id, $limit)
	{
		...
		$customers->orderBy('createdate', 'DESC');
	...
	//Start special
	public function getCustomerSpecial($customer_id, $limit)
	{
		...
		$customers->where('user_id', '=', $customer_id);
		$customers->orderBy('created', 'DESC');
