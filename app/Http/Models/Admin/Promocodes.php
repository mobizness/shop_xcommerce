...
class Promocodes extends Model{
	...
	public function getPromocodeProducts($id){
		return DB::table('promocodes_to_product as ptp')->select('ptp.*', 'p.product_name', 'p.product_code')->leftjoin('products as p','p.id', '=','ptp.product_id' )->where('ptp.promocode_id', $id)->get();
	}
