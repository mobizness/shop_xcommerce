                                    ...
                                    <div class="tab-content">
                                        <div id="tab-bestsellers" class="tab-pane fade in active">
                                            <table class="table table-hover table-striped mbn">
												...
												?>
                                                <tr>
                                                    <td><a href="products/editProduct/<?php echo $bestsellerdatas->product_id; ?>"><?php echo $bestsellerdatas->product_name; ?></a></td>
                                        ...
                                        <div id="tab-most-viewed-products" class="tab-pane fade">
                                        	<table class="table table-hover table-striped mbn">
            									...
            									?>
                                                <tr>
                                                    <td><a href="products/editProduct/<?php echo $mostViwedProduct->product_id; ?>"><?php echo $mostViwedProduct->product_name; ?></a></td>
                                    ...
                                    <table class="table table-border-dashed table-hover mbn">
										...
										@foreach($data['last5Orders'] as $last5Order)
											<tr>
												...
												<td class="text-right">{{ number_format($last5Order->total + $last5Order->shipping_charge*1.06, 2) }}</td>
											</tr>
										@endforeach
                                        </tbody>
                                    </table>
...
$(function () {
	...
	?>
    var d1 = [
		["Jan", <?php if(isset($jan)) echo $jan; else echo 0; ?>],
		["Feb", <?php if(isset($feb)) echo $feb; else echo 0; ?>],
		["Mar", <?php if(isset($mar)) echo $mar; else echo 0; ?>],
		["Apr", <?php if(isset($apr)) echo $apr; else echo 0; ?>],
		["May", <?php if(isset($may)) echo $may; else echo 0; ?>],
		["Jun", <?php if(isset($jun)) echo $jun; else echo 0; ?>],
		["Jul", <?php if(isset($jul)) echo $jul; else echo 0; ?>],
		["Aug", <?php if(isset($aug)) echo $aug; else echo 0; ?>],
		["Sep", <?php if(isset($sep)) echo $sep; else echo 0; ?>],
		["Oct", <?php if(isset($oct)) echo $oct; else echo 0; ?>],
		["Nov", <?php if(isset($nov)) echo $nov; else echo 0; ?>],
		["Dec", <?php if(isset($dec)) echo $dec; else echo 0; ?>]
	];
    ...
    $('#revenue-number').animateNumber({
        ...
        number: <?php if(isset($data['todaySale'][0]->totalPrice)) echo $data['todaySale'][0]->totalPrice; else echo 0;?>,
    ...
    $('#tax-number').animateNumber({
        ...
        number: <?php if(isset($data['todaySale'][0]->totalPrice)) echo $data['todaySale'][0]->totalPrice*0.06 + $data['todaySale'][0]->shipping_charge*0.06; else echo 0;?>,
    ...
    $('#shipping-number').animateNumber({
        ...
        number: <?php if(isset($data['todaySale'][0]->shipping_charge)) echo $data['todaySale'][0]->shipping_charge; else echo 0;?>,
    ...
    var d6_1 = [
        ...
        ["Jan", <?php if(isset($jan)) echo $jan; else echo 0; ?>],
		["Feb", <?php if(isset($newfeb)) echo $newfeb; else echo 0; ?>],
		["Mar", <?php if(isset($newmar)) echo $newmar; else echo 0; ?>],
		["Apr", <?php if(isset($newapr)) echo $newapr; else echo 0; ?>],
		["May", <?php if(isset($newmay)) echo $newmay; else echo 0; ?>],
		["Jun", <?php if(isset($newjun)) echo $newjun; else echo 0; ?>],
		["Jul", <?php if(isset($newjul)) echo $newjul; else echo 0; ?>],
		["Aug", <?php if(isset($newaug)) echo $newaug; else echo 0; ?>],
		["Sep", <?php if(isset($newsep)) echo $newsep; else echo 0; ?>],
		["Oct", <?php if(isset($newoct)) echo $newoct; else echo 0; ?>],
		["Nov", <?php if(isset($newnov)) echo $newnov; else echo 0; ?>],
		["Dec", <?php if(isset($newdec)) echo $newdec; else echo 0; ?>]
    ];



	<?php ///////////// RETURN CUSTOMERS
    ...
    var d6_2 = [
        ...
        ["Jan", <?php if(isset($returnjan)) echo $returnjan; else echo 0; ?>],
		["Feb", <?php if(isset($returnfeb)) echo $returnfeb; else echo 0; ?>],
		["Mar", <?php if(isset($returnmar)) echo $returnmar; else echo 0; ?>],
		["Apr", <?php if(isset($returnapr)) echo $returnapr; else echo 0; ?>],
		["May", <?php if(isset($returnmay)) echo $returnmay; else echo 0; ?>],
		["Jun", <?php if(isset($returnjun)) echo $returnjun; else echo 0; ?>],
		["Jul", <?php if(isset($returnjul)) echo $returnjul; else echo 0; ?>],
		["Aug", <?php if(isset($returnaug)) echo $returnaug; else echo 0; ?>],
		["Sep", <?php if(isset($returnsep)) echo $returnsep; else echo 0; ?>],
		["Oct", <?php if(isset($returnoct)) echo $returnoct; else echo 0; ?>],
		["Nov", <?php if(isset($returnnov)) echo $returnnov; else echo 0; ?>],
		["Dec", <?php if(isset($returndec)) echo $returndec; else echo 0; ?>]
