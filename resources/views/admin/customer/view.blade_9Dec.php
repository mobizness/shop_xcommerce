                                        ...
                                        <div class="form-group">
	                                        ...
	                                        <div class="col-md-6">
    		                                    <div data-on="success" data-off="primary" class="make-switch">
            		    	                        <input type="checkbox" <?php echo ($customer->status ? 'checked="checked"' : ''); ?> name="status" />
                    	    	                </div>
                                	        </div>
                                        </div>
                                    	<div class="clearfix"></div>
                                ...
                                <div class="table-responsive mtl">
                                    ...
                                    <thead>
                                      <tr>
                                        ...
                                        <th>#</th>
                                        <th><a href="javascritp:void(0)">Order ID</a></th>
                                        <th><a href="javascritp:void(0)">Order Date</a></th>
                                        <th><a href="javascritp:void(0)">Login/E-mail</a></th>
                                        <th><a href="javascritp:void(0)">Customer Name</a></th>
                                        <th><a href="javascritp:void(0)">Amount</a></th>
                                        <th><a href="javascritp:void(0)">Order Status</a></th>
                                        <th><a href="javascritp:void(0)">Payment Status</a></th>
                                        <th>Action</th>
                                      </tr>
                                    </thead>
                                    <tbody>
...
//dd($order, $orderTax);
?>
                                            <td>RM {{ number_format($orderTax->total, 2) }}</td>
                                          ...
                                          @if($order->payment_status == 'Paid')
                                          	<?php $totalPaid += $order->totalPrice; ?>
                                          @endif
                                          <?php $totalAmountOrders += $order->totalPrice; ?>
                                        @endforeach
                                      @else
                                      	<tr>
                                    ...
                                    <table id="example1" class="table table-hover table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><a href="javascript:void(0)">Created Date</a></th>
                                                <th><a href="javascript:void(0)">Qty</a></th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    ...
                                    <table id="example1" class="table table-hover table-striped">
                                        <thead>
                                          <tr>
                                            <th width="1%"><input type="checkbox"/></th>
                                            <th>#</th>
                                            <th><a href="#sort by name" title="Sort by name">Event Name</a></th>
                                            <th><a href="#sort by event date" title="Sort by event date">Event Date</a></th>
                                            <th>Gifts</th>
                                            <th>Action</th>
                                          </tr>
                                        </thead>
