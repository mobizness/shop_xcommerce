      ...
      <div id="page-wrapper">
        ...
        <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">By Product Category - Listing</li>
          </ol>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>By Product Category <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  ...
                  <a href="#" class="btn btn-success" data-target="#modal-add-product-category" data-toggle="modal">Add New &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                  <div class="btn-group">
...
<div class="tools"> <i class="fa fa-chevron-up"></i> </div>
                  <div id="modal-add-product-category" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                          <h4 id="modal-login-label3" class="modal-title">Add New By Product Category</h4>
                        </div>
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal" id="form_add_product_category">
                              ...
                              <div class="form-group">
                                <label for="inputFirstName" class="col-md-3 control-label">Title <span class="text-red">*</span></label>
                                <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <select name="category_id" class="form-control" onchange="load_category_products('modal-add-product-category',this.value)">
                              ...
                              <div class="form-group">
                                <label for="inputFirstName" class="col-md-3 control-label">Courier Charge (RM) <span class="text-red">*</span></label>
                                <div class="col-md-6">
                              ...
                              <div class="form-actions">
                                ...
                                <a href="javascript:void(0)" class="btn btn-red" onclick="save_product_category('modal-add-product-category')">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green" onclick="$('#form_add_product_category')[0].reset();">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                          </div>
                        </div>
                  ...
                  <div id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">                         
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8"> <a href="javascript:void(0)" onclick="continue_delete_process_shipping_category()" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="javascript:void(0)" data-dismiss="modal" class="btn btn-green" onclick="cancel_delete()">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <!--Modal edit discount start-->
                      <div id="modal-edit-shipping-category" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog modal-wide-width">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                ...
                <?php			
					  ...
					  if(sizeof($product_categories) > 0)
					  {
						 ...
						 $per_page = (Session::has('product_category.per_page')) ? Session::get('product_category.per_page') : 30;
					  ?>
                
                      <div class="form-inline pull-left">
                        <div class="form-group">
                          <select name="select" class="form-control" onchange="set_per_page(this.value,'product_category','{{ Request::path() }}','{{ $query_string }}')">
                      ...
                      <input type="hidden" id="query_string" value="{{ $query_string }}" />
                        ...
                        <table id="example1" class="table table-hover table-striped">
                          ...
                          <tbody>
                          	<?php
								$i = 1;
								foreach($product_categories as $details)
								{
									$status_class = ($details->status == '0') ? 'label-red' : 'label-success';
									$status = ($details->status == '0') ? 'In-active' : 'Active';
																		
									// get discount category
									$shipping_category = DB::table('shipping_by_product_category')->where('shipping_product_category_id',$details->id)->lists('category_id');
									...
									{							
										$categoriesList = $this->CategoryModel->getSelectedCategoriesTree($shipping_category);
										
										// get discount products
										$discount_products = DB::table('shipping_by_product')->where('shipping_product_id',$details->id)->lists('product_id');
									
										// get category products										
										$category_products_list = $this->ProductModel->categoryProducts($shipping_category[0]);									
							...
							?>
									<tr>
                                      ...
                                      <td><a href="#" data-hover="tooltip" data-placement="top" title="Edit" data-target="#modal-edit-shipping-category-<?php echo $details->id; ?>" data-toggle="modal"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" onclick="delete_item(<?php echo $details->id; ?>)" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                      
                                      
                                      <!--Modal edit discount start-->
                                          <div id="modal-edit-shipping-category-<?php echo $details->id; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                            <div class="modal-dialog modal-wide-width">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                                ...
                                                <div class="modal-body">
                                                  <div class="form">
                                                    <form class="form-horizontal" id="form_edit_product_category">
                                                      <div class="form-group">
                                                        <label class="col-md-3 control-label">Status <span class="text-red">*</span></label>
                                                        <div class="col-md-6">
                                                          <div data-on="success" data-off="primary" class="make-switch">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                          <div class="xs-margin"></div>
                                                          <select name="category_id" class="form-control" onchange="load_category_products('modal-edit-shipping-category-<?php echo $details->id; ?>',this.value)">
                                                      ...
                                                      <div class="form-group">
                                                        <label for="inputFirstName" class="col-md-3 control-label">Courier Charge (RM)</label>
                                                        <div class="col-md-6">
                                                          <input type="text" name="charge" class="form-control" placeholder="" value="{{ number_format($details->charge,2) }}">
                                                        </div>
                                                      </div>
                                                      <div class="clearfix"></div>
                                                      <div class="form-actions">
                                                        ...
                                                        <a href="javascript:void(0)" onclick="update_product_category('modal-edit-shipping-category-<?php echo $details->id; ?>')" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                                      </div>
                                                    </form>
                                                  </div>
                                                </div>
...
function load_category_products(model_id,category_id)
{
	...
	$.ajax({
			url: '{{ url("/web88cms/categoryProducts") }}',
			type: 'POST',
			dataType: 'json',
...
function continue_delete_process_shipping_category()
{
	...
	$.ajax({	   
		   type : 'POST',
		   url: '{{ url("/web88cms/shippingbycategory/deleteShippingByCategory") }}',
		   data : 'item_id='+item_id+'&_token='+$('#csrf_token').val(),
		   success : function(response){	
		   		if(query_string == '')				
					window.location.href = "{{ url("/web88cms/shippingbycategory/byShippingByCategory") }}";
				else
					window.location.href = "{{ url("/web88cms/shippingbycategory/byShippingByCategory") }}?"+query_string;
		   }
	});	// end ajax	
}

function save_product_category(model_id)
{
	$.ajax({
			url: '{{ url("/web88cms/shippingbycategory/addShippingByCategory") }}',
			type: 'POST',
			dataType: 'json',
			data: $('#form_add_product_category').serialize(),
			beforeSend: function(){
			...
			success: function(response){
				if(response['error'])
				{
					...
					error += '</div>';
					$('#'+model_id+' #form_add_product_category').before(error);	
				}
				...
				if(response['success'])
				{
					...
					$('#'+model_id+' #form_add_product_category').before(success);
					
					$('#'+model_id+' #apply_to_all').hide();
					$('#'+model_id+' #form_add_product_category')[0].reset();
...
function update_product_category(model_id)
{
	$.ajax({
			url: '{{ url("/web88cms/shippingbycategory/updateShippingByCategory") }}',
			type: 'POST',
			dataType: 'json',
			data: $('#'+model_id+' #form_edit_product_category').serialize(),
			beforeSend: function(){
			...
			success: function(response){
				if(response['error'])
				{
					...
					error += '</div>';
					$('#'+model_id+' #form_edit_product_category').before(error);	
				}
				...
				if(response['success'])
				{
					...
					$('#'+model_id+' #successElement').remove();
					var success = '<div id="successElement" class="alert alert-success"><i class="fa fa-check-circle"></i> <strong>Success!</strong><p>The information has been saved/updated successfully.</p></div>';
					$('#'+model_id+' #form_edit_product_category').before(success);
