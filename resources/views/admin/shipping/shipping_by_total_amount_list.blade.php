      ...
      <div id="page-wrapper">
        ...
        <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">By Total Order Amount - Listing</li>
          </ol>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>By Total Order Amount <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">By Total Order Amount</div>
                  <br/>
                    ...
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal" id="form_add_shipping_amount">
                              ...
                              <div class="form-actions">
                                ...
                                <a href="javascript:void(0)" class="btn btn-red" onclick="save_shipping_amount('modal-add-shipping')">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green" onclick="$('#form_add_shipping_amount')[0].reset();">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                          </div>
                        </div>
                ...
                <?php					  
					  if(sizeof($shipping_order_amounts) > 0)
					  {
			...
			<tr>
                          ...
                          <tbody>
                          	<?php
								$i = 1;
								foreach($shipping_order_amounts as $details)
								{
							...
							?>
									<tr>
									  ...
									  <td>{{ $details->title }}</td>
                                      <td>{{ number_format($details->from_amount, 2) }} </td>
									  <td>{{ number_format($details->to_amount, 2)  }}</td>
                                          ...
                                          <div id="modal-edit-shipping-amount-<?php echo $details->id; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                            <div class="modal-dialog modal-wide-width">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <div class="form">
                                                    <form class="form-horizontal" id="form_edit_shipping_amount">
                                                      <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                          <input type="text" name="from_amount" class="form-control" placeholder="Amount" value="{{ number_format($details->to_amount,2) }}">
                                                        </div>
                                                      </div>
                                                      <div class="clearfix"></div>
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                          <input type="text" name="to_amount" class="form-control" placeholder="" value="{{ number_format($details->to_amount,2) }}">
                                                        </div>
                                                      </div>
                                                      <div class="clearfix"></div>
                                                      <div class="form-group">
...
function save_shipping_amount(model_id)
{
	$.ajax({
			url: '{{ url("/web88cms/shipping/addShippingOrderAmount") }}',
			type: 'POST',
			dataType: 'json',
			data: $('#form_add_shipping_amount').serialize(),
			beforeSend: function(){
			...
			success: function(response){
				if(response['error'])
				{
					...
					error += '</div>';
					$('#'+model_id+' #form_add_shipping_amount').before(error);	
				}
				...
				if(response['success'])
				{
					...
					$('#'+model_id+' #form_add_shipping_amount').before(success);
					
					$('#'+model_id+' #apply_to_all').hide();
					$('#'+model_id+' #form_add_shipping_amount')[0].reset();
