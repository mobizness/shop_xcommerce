...
<div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
        ...
        <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Left Banners - Listing</li>
          </ol>
        </div>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Left Banners <i class="fa fa-angle-right"></i> Listing</h2>
         ...
         <div class="clearfix"></div>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Left Banners Listing</div>
                  <br/>
                                ...
                                <div class="modal-dialog modal-wide-width">
                                  ...
                                  <div class="col-md-9">
									...
									<?php if($details->enlarge_banner!='')
												 {?>
                                    <img alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/left/', $details->enlarge_banner?>" class="img-responsive" /> <br/>
                                  <br/>  
                                  ...
                                  <div class="col-md-9">
                                    ...
                                    <?php if($details->pdf_link!='')
												 {?>
                                    <a href="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/left/', $details->pdf_link?>"><?php echo $details->pdf_link;?></a> <br/>
                                    ...
                                    <input type="text" placeholder="http://" class="form-control" name="url" id="url<?php echo $details->id; ?>" onkeyup="urllink('<?php echo $details->id; ?>'); return;" onmouseout="urllink('<?php echo $details->id; ?>'); return;"   value="<?php if(($details->url)!=''){echo $details->url;}  ?>" <?php if(( $details->enlarge_banner!='')||($details->pdf_link!='')){ echo 'disabled="disabled"'; }?>/>
                                      ...
                                      <span class="help-block">Please enter the page link to link it to the sub page.</span> </div>
                                          ...
                                          <div class="form-actions">
                                            ...
                                            <a href="#edit" onClick="chkSize('<?php echo $details->id; ?>');chkSizebanner('<?php echo $details->id; ?>');chkSizeenlargebanner('<?php echo $details->id; ?>'); editleftbanner(<?php echo $details->id;  ?>);" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>
