                                                          ...
                                                          <table class="table checkout-table table-responsive">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="item-name-col">
                                                                	<figure><a href="#link to product item"><img src="<?php echo asset('/public/admin/products/large/'.$elm->large_image) ?>" alt="'{{ $elm->product_name }}" class="img-responsive" width="100"></a></figure>
                                                                    <header class="item-name">
                                                                    	<a href="#link to product item">{{ $elm->product_name }}</a>
                                                                    </header>
                                                                </td>
                                                                <td class="item-code">{{ $elm->product_code }}</td>
