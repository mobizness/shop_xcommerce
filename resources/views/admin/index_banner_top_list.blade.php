    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="portlet">
                    ...
                    <div class="form">
                      <form class="form-horizontal" name="topbanner" id="topbanner" method="post" action="" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <div class="text-15px margin-top-10px">
                              ...
                              <br/>
                              <span class="help-block">(Image dimension: 870 x 520 pixels, JPEG/GIF/PNG only, Max. 1MB) </span> </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <div class="input-group input-daterange">
                              <input type="text" name="start_date" class="form-control" id="start_date" required="required" placeholder="1st June, 2015" />
                              <span class="input-group-addon">to</span>
                              <input type="text" name="end_date" class="form-control" id="end_date" required="required" placeholder="1st June, 2015"/>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-actions">
                          ...
                          <!--  <input type="submit" value="Save" class="btn btn-red" name="submit" id="submit" />-->
                            <a  href="#add" onclick="chkSize('0');chkSizebanner('0');chkSizeenlargebanner('0'); addmaintopBanner();"class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a onClick="$('.form-horizontal').trigger('reset');" href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                        </div>
                      </form>
                      <script>
          ...
          <div class="portlet-body">
            ...
            <div class="pull-right"> 
                    ...
                    <!--<span class="btn btn-danger "> <input onclick="myupd(); return;" class="btn btn-danger myclass" type="button" name="Update_Display_Order" value="Update Display Order" /> <i class="fa fa-refresh"></i></span>-->  
                   <!--<script>
				   function myupd()
				   {
				   var form = document.getElementById("#updatedisplaytopbanner");

				document.getElementById("#updatedisplaytopbanner").addEventListener("click", function () {
				  form.submit();
            ...
            <div class="table-responsive mtl">
                              ...
                              <div class="form">
                                ...
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      <input id="title" type="text" class="form-control" placeholder="Banner 1" name="title" value="<?php echo $details->title; ?>" >
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="col-md-3 control-label">Upload Banner <span class='require'>*</span></label>
                                    <div class="col-md-9">
                                      <div class="text-15px margin-top-10px"> <!--<img src="../images/homeslider/slide1.jpg" alt="Banner" class="img-responsive">--><br/>
                                        
                                        <?php if($details->banner!='')
												 {?>
                                        <img  alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/top/', $details->banner?>" class="img-responsive" />
                                        <?php }?>
                                  ...
                                  <div class="col-md-9">
									...
									<?php if($details->enlarge_banner!='')
												 {?>
                                    <img alt="" src="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/top/', $details->enlarge_banner?>" class="img-responsive" /> <br/>
                                  <br/>  
                                  ...
                                  <div class="col-md-9">
                                    ...
                                    <?php if($details->pdf_link!='')
												 {?>
                                    <a href="<?php echo "http://".$_SERVER['HTTP_HOST']. '/public/admin/images/banner/top/', $details->pdf_link?>"><?php echo $details->pdf_link;?></a> <br/>
                                  ...
                                  <div class="form-actions">
                                    <div class="col-md-offset-5 col-md-8">
                                     <!--<input type="submit" value="Edit" class="btn btn-red" name="submit" id="submit" />-->
                                      
                                      <!--<a href="#" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp;--> 
                                     <a  onClick="chkSize('<?php echo $details->id; ?>');chkSizebanner('<?php echo $details->id; ?>');chkSizeenlargebanner('<?php echo $details->id; ?>'); edittopbanner(<?php echo $details->id;  ?>);" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp;
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="delete_enlarge" id="delete_enlarge<?php echo $details->id; ?>" method="post" action="index_banner_top_list/delete_enlarge" enctype="multipart/form-data" class="delete_enlarge<?php echo $details->id; ?>" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <script>
											function deletemiddleopenlargeBanner<?php echo $details->id; ?>(){
												...
												$.ajax({			
													url: 'index_banner_top_list/delete_enlarge',
													type:'post',
													dataType:'json',
													data: form_data,
													enctype: 'multipart/form-data',
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                              <form  name="delete_pdf" id="delete_pdf<?php echo $details->id; ?>" method="post" action="index_banner_top_list/delete_enlarge" enctype="multipart/form-data" class="delete_enlarge<?php echo $details->id; ?>" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <script>
											function deletemiddle_top_pdfBanner<?php echo $details->id; ?>(){
												...
												$.ajax({			
													url: 'index_banner_top_list/delete_pdf',
													type:'post',
													dataType:'json',
													data: form_data,
													enctype: 'multipart/form-data',
              ...
              <ul class="pagination pagination mtm mbm">
			   ...
			   {$disabled1= '';}
				echo "<li ".$disabled1."><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_banner_top_list?page=1>".'&laquo;'."</a></li> "; // Goto 1st page
			   ...
			   {$active= '';}
			echo "<li ".$active." ><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_banner_top_list?page=".$i.">".$i."</a></li> "; 
}; 
		...
		if((isset($_GET['page'])&&($_GET['page']==$total_pages)) || $total_pages==1)
			   ...
			   {$disabled= '';}
            echo "<li ".$disabled."><a href= http://".$_SERVER['HTTP_HOST']."/web88cms/index_banner_top_list?page=$total_pages>".'&raquo;'."</a></li> "; // Goto last page
?>
              </ul>
            </div>
              <div class="clearfix"></div>
