        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul id="myTab" class="nav nav-tabs">
                    ...
                    <li <?= ($page ? 'class="active"' : '') ?>><a href="#orders" data-toggle="tab">Orders</a></li>
                </ul>
                ...
                <div id="myTabContent" class="tab-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control" name="free_shipping">
                                                        <option value="Not Influence">Do not influence Order Free Shipping option</option>
                                                        <option <?= ($promocode->free_shipping == 'Enable') ? 'selected="selected"' : '' ?> value="Enable">Enable Free Shipping</option>
                                                        <option <?= ($promocode->free_shipping == 'Disable') ? 'selected="selected"' : '' ?> value="Disable">Disable Free Shipping</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table table-hover table-striped table-responsive">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $promocodeProduct->product_name }}</td>
                                                                <td>
                                                                ...
                                                                <div id="modal-delete-pro-{{ $promocodeProduct->product_id }}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                                                  <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                      ...
                                                                      <div class="modal-body">
                                                                        <p>{{ $promocodeProduct->product_name }}</p>
                                                                        <div class="form-actions">
                                                                          <div class="col-md-offset-4 col-md-8">
                    ...
                    <div id="orders" class="tab-pane fade<?= ($page ? ' in active' : '') ?>">
                        <div class="portlet">
                                    	...
                                    	<thead>
                                            <tr>
                                                ...
                                                @if ($sort_by == 'email' && $sort == 'ASC')
                                                    <th><a href="<?php echo $sorting_url . '&sort_by=email&sort=DESC'; ?>">Login/E-mail</a></th>
                                                @else
                                                    <th><a href="<?php echo $sorting_url . '&sort_by=email&sort=ASC'; ?>">Login/E-mail</a></th>
                                                @endif
                                        ...
                                        @if($orders)
                                            @foreach($orders as $order)
                                                <tr>
                                                    ...
                                                    <td><a href="javascript:void(0)">{{ $order->billing_email }}</a></td>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('web88cms/orders/detail/' . $order->id) }}" data-hover="tooltip" data-placement="top" title="View Details"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
						...
						html += '<td class="item-name-col">';
							html += '<figure>';
								html += '<a href="#link to product item">';
									html += '<img src="<?php echo asset('/public/admin/products/large') ?>/'+ product.large_image +'" alt="'+ product.product_name +'" class="img-responsive" width="100">';
								html += '</a>';
							html += '</figure>';
							
							html += '<header class="item-name">';
								html += ' <a href="{{ url('web88cms/products/editProduct') }}/' + product.id + '">'+ product.product_name +'</a>';
							html += ' </header>';
						html += '</td>';
						html += '<td class="item-code">'+ product.product_code +'</td>';
