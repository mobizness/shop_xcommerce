                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control" name="free_shipping">
                                                        ...
                                                        <option <?= (Input::get('free_shipping') == 'Enable') ? 'selected="selected"' : '' ?> value="Enable">Enable Free Shipping</option>
                                                        <option <?= (Input::get('free_shipping') == 'Disable') ? 'selected="selected"' : '' ?> value="Disable">Disable Free Shipping</option>
                                                    </select>
                                                </div>
                                            </div>
