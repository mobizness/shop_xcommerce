    ...
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12">
	            ...
	            <h5 class="block-heading pull-right">Total: <span class="text-red">RM {{ number_format($orderTax->total, 2)}}</span></h5>
	            <div class="clearfix"></div>
                                ...
                                <div class="row">
                                    ...
                                    <!-- order information start -->
                                        ...
                                        <div class="form-group">
                                        	...
                                        	<div class="col-md-8"><p class="text-red"><strong>RM {{ number_format($orderTax->total, 2) }}</strong></p></div>
                                        </div>
                                        <div class="clearfix"></div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select class="form-control" name="shipping_method">
                                                                        ...
                                                                        <option <?php $order->shipping_method == 'Poslaju National Courier' ? 'selected="selected"' : '' ?> value="Poslaju National Courier">Poslaju National Courier</option>
                                                                        <option <?php $order->shipping_method == 'Self Collection' ? 'selected="selected"' : '' ?>value="Self Collection">Self Collection</option>
                                                                    </select>			
                                                                </div>
                                                            </div>
                                                            <div class="clearfix"></div>
                                    ...
                                    <tbody>
                                    	@foreach($orderTax->products as $orderProduct)
                                            <tr>
                                                ...
                                                <td class="item-price-col" align="right"><span class="item-price-special">{{ number_format($orderProduct->amount, 2) }}</span></td>
...
-->
                                        <tr>
                                            ...
                                            <td style="border: none;" align="right">{{ number_format($orderTax->shipping, 2) }}</td>
                                            <td style="border: none;" align="right">{{ number_format($orderTax->shipping * 0.06, 2) }}</td>
                                            <td style="border: none;" align="right">{{ number_format($orderTax->shipping * 1.06, 2) }}</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td align="right"><b>{{ number_format($orderTax->tax + $orderTax->shipping * 0.06, 2) }}</b></td>
                                            <td align="right"><b>{{ number_format($orderTax->total + $orderTax->shipping * 1.06, 2) }}</b></td>
                                        </tr>
                                    </tfoot>
                                </table>
	                            <div class="clearfix"></div>
