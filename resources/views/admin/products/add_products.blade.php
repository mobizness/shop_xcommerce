                      ...
                      <div class="row">
                          	<div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                	<select class="form-control" name="brand_id">
														...
														if(sizeof($brands) > 0)
														{
															...
															{
																$selected = (isset($input['brand_id']) && ($input['brand_id'] == $brandDetails->id)) ? 'selected="selected"' : '';
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="checkbox-list">
														...
														if(sizeof($colors) > 0)
														{
															...
															{
																$checked = (isset($input['colors']) && in_array($colorDetails->id,$input['colors'])) ? 'checked="checked"' : '';
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                	<input type="text" class="form-control" name="manufacturer_part_number" placeholder="" value="<?php echo (isset($input['manufacturer_part_number'])) ? $input['manufacturer_part_number'] : ''; ?>">
                                                    <div class="xss-margin"></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                	<input type="text" class="form-control" name="ships_in" placeholder="" value="<?php echo (isset($input['ships_in'])) ? $input['ships_in'] : ''; ?>">
                                                    <div class="xss-margin"></div>
                                            ...
                                            <div class="form-group">
                                             	<label for="inputFirstName" class="col-md-3 control-label">Tag</label>
                                                    <div class="col-md-5">
                                                        <input type="text" name="tags" class="form-control" placeholder="eg. Digital Gadget" value="<?php echo (isset($input['tags'])) ? $input['tags'] : ''; ?>"/><span class="input-group-btn"><!--<button type="button" class="btn btn-primary">Add</button>--></span>
                                                        <div class="xss-margin"></div>
                          ...
                          <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="xss-margin"></div><input type="checkbox" name="is_available" <?php if(isset($input['is_available'])){ echo 'checked="checked"'; } ?>> Available<br>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="available_since" class="datepicker-default form-control" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="<?php echo (isset($input['available_since'])) ? $input['available_since'] : ''; ?>"/>
                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                        </div>
                                                        <div class="xss-margin"></div>
                                                        <input type="checkbox" name="in_physical_store_only" <?php if(isset($input['in_physical_store_only'])){ echo 'checked="checked"'; } ?>> Available in Physical Store Only.
                                                        <div class="xss-margin"></div>
