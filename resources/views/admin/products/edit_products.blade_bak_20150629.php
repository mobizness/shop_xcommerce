                                          ...
                                          <div class="form">
                                            <form class="form-horizontal" method="post" action="{{ url('/web88cms/products/updateQuantityDiscount/') }}">
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch">
                                                    <input type="checkbox" <?php if($details->status == '1'){ echo 'checked="checked"'; } ?>/>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label for="inputFirstName" class="col-md-3 control-label">Discount </label>
                                                <div class="col-md-6">
                                                  <input type="text" class="form-control" placeholder="Amount" name="discount" value="{{ $details->discount }}">
                                                  <div class="xs-margin"></div>
                                                  <select name="discount_by" class="form-control">
