            ...
            <div class="col-lg-12">
			 ...
			 // dd($details);
              ...
              <ul id="myTab" class="nav nav-tabs">
                ...
                <li><a href="#pwp" data-toggle="tab" onclick="document.getElementById('description-feature').style.height='0px'; document.getElementById('description-feature').style.overflow='hidden';">PWP Setup</a></li>
              </ul>
                      ...
                      <div class="row">
                          	<div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                	<input type="text" class="form-control" placeholder="Product Name" name="product_name" value="<?php echo htmlspecialchars($productDetails->product_name,ENT_QUOTES); ?>">
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                      ...
                                                      @if($productDetails->large_image != '')
                                                      	<img src="{{ asset('/public/admin/products/medium/'. $productDetails->large_image) }}" alt="<?php echo htmlspecialchars($productDetails->product_name,ENT_QUOTES); ?>" class="img-responsive" width="100">
                                                        <a href="javascript:void(0)" data-target="#modal-delete-large-image" data-toggle="modal" data-hover="tooltip" data-placement="top" title="Delete"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                                     @endif
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="text-15px margin-top-10px">
                                                    	...
                                                    	@if($productDetails->thumbnail_image_1 != '')
                                                        	<img src="{{ asset('/public/admin/products/medium/'. $productDetails->thumbnail_image_1) }}" alt="<?php echo htmlspecialchars($productDetails->product_name,ENT_QUOTES); ?>" class="img-responsive">
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="text-15px margin-top-10px">
                                                    	...
                                                    	@if($productDetails->thumbnail_image_2 != '')
                                                        	<img src="{{ asset('/public/admin/products/medium/'. $productDetails->thumbnail_image_2) }}" alt="<?php echo htmlspecialchars($productDetails->product_name,ENT_QUOTES); ?>" class="img-responsive">
                                                            <a href="javascript:void(0)" data-target="#modal-delete-thumbnail-2" data-toggle="modal" data-hover="tooltip" data-placement="top" title="Delete"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                                         @endif
                                        ...
                                        <div class="form-group border-bottom">
                                       			...
                                       			<?php
													  if(sizeof($additional_images) > 0)
													  {
														...
														{
															echo '<div style="float:left; margin:0 10px 10px;"><img src="'.asset('/public/admin/products/medium/'. $product_image->file_name).'" alt="'.htmlspecialchars($productDetails->product_name,ENT_QUOTES).'" class="img-responsive" style="width:125px;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ url('/web88cms/products/updateShippingInfo/'. $productDetails->id) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                            @if (!empty($csv_ships))
                                            @foreach ($csv_ships as $title => $ships)
                                            <strong>{{$title}}</strong>
                                            <ul>
                                              @foreach ($ships as $ship)
                                              <li>{{$ship['destination']}} : {{$ship['charge']}} MYR</li>
                                              @endforeach
                                            </ul>
                                            @endforeach
                                             @else
                                              No Csv shipping method available
                                            @endif
                                            </div>
                                        </div>
                                    	<div class="clearfix"></div>
                ...
                <div id="quantity-discount" class="tab-pane fade">
                    ...
                    <div class="portlet-body">
                      {{-- <div class="form-inline pull-left">
                        <div class="form-group">
                          <select name="select" class="form-control" onchange="set_per_page(this.value,'quantity_discount','{{ Request::path() }}','{{ $query_string }}')">                            <option <?php if($per_page == 10){ echo 'selected="selected"'; } ?>>10</option>
                      ...
                      <div class="table-responsive mtl">
                        ...
                        <div class="tool-footer text-right">
                          ...
                          <?php echo $quantity_discounts->setPath(Request::url())->appends(Input::get())->render(); ?>
                        </div>
                        <div class="clearfix"></div>
                      </div>
                    </div>
                      ...
                      <div class="table-responsive mtl">
                        <table class="table table-hover table-striped">
                          ...
                          <tr>
                            ...
                            <td><a href="product_edit.html">{{$pwp->product->product_name}}</a> <br/>
                              Product Code: {{$pwp->product->product_code}}</td>
