                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="form-actions">
                                            	<form name="deleteSubscriber<?php echo $details->id;?>" id="deleteSubscriber<?php echo $details->id;?>" action="newsletter/deleteSubscriber" method="post" class="form-horizontal">
                                            		<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                                                	<input type="hidden" name="subscriberId" value="<?php echo $details->id;?>" />
