                                    ...
                                    <table class="table checkout-table">
                                            ...
                                            @foreach($cartProducts['products'] as $cartProduct)
                                            	<?php
                                            		$discount += ($cartProduct->cart['quantityDiscount'] * $cartProduct->cart['quantity']) + $cartProduct->cart['globalDiscount'] + $cartProduct->cart['promocodeDiscount'];
		                                       		$price = $cartProduct->cart['quantity'] * $cartProduct->sale_price;
		                           					$tax = 0;
										...
										//	dd($cartProduct);
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right; padding-right: 10px">{{ $cartProduct->cart['quantity'] }}</td>
                                                    <td style="text-align: right; padding-right: 10px" class="item-price-col"><span class="item-price-special">{{ number_format($cartProduct->sale_price, 2) }}</span></td>
                                                    ...
                                                    <td style="text-align: right; padding-right: 10px" class="item-price-col"><span class="item-price-special">{{ number_format($price + $tax, 2) }}</span></td>
                                                </tr>
                                            @endforeach
                                            
                                            <tr>
                                                <td style="text-transform:none; border: none; text-align: right;" class="checkout-table-price" colspan="3">Total:</td>
                                                <td></td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($gst, 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($cartProducts['totalPrice'] + $gst, 2) }}</td>
                                            </tr>
<!--
                                            <tr>
                                                <td class="checkout-table-title" colspan="5">GST:</td>
                                                <td class="checkout-table-price">RM {{ number_format($gst, 2) }}</td>
                                            </tr>
-->
                                            <tr>
                                                <td style="text-transform:none; border: none; text-align: right;" class="checkout-table-price" colspan="3">Shipping:</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($cartProducts['shippingTotal'], 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($cartProducts['shippingTotal'] * 0.06, 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($cartProducts['shippingTotal'] * 1.06, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td style="text-transform:none; border: none; text-align: right;" class="checkout-table-price text-red" colspan="3">Discount:</td>
                                                <td></td>
                                                <td></td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price text-red">- {{ number_format($discount, 2) }}</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <td style="text-transform:none; border: none; text-align: right;" class="checkout-table-price" colspan="3">Net Total:</td>
<!--                                                <td class="checkout-total-title" colspan="3"><b>Net Total:</b></td>-->
                                                <td></td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($gst, 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($cartProducts['totalPrice'] + $gst + $cartProducts['shippingTotal'] * 1.06 - $discount, 2) }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
