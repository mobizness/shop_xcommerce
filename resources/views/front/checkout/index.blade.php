...
-->
                                            <tr>
                                                ...
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($shipping_charge, 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($shipping_charge * 0.06, 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($shipping_charge * 1.06, 2) }}</td>
                                            </tr>
                                            <tr>
...
<!--                                                <td class="checkout-total-title" colspan="3"><b>Net Total:</b></td>-->
                                                <td></td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($gst + $shipping_charge * 0.06, 2) }}</td>
                                                <td style="text-align: right; padding-right: 10px" class="checkout-table-price">{{ number_format($cartProducts['totalPrice'] + $gst + $shipping_charge * 1.06 - $discount, 2) }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
