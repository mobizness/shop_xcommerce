                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="item-name-col">
                                        ...
                                        @if($orderProduct->token)
                                            <a href="{{ url('event/view') . '?token=' . $orderProduct->token }}" class="btn btn-custom btn-xs"><i class="fa fa-angle-double-left"></i>&nbsp; BACK TO SPECIAL LIST</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="checkout-table-price text-red">- RM {{ number_format($orderInfo->discount, 2) }}</td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
