                                                 ...
                                                 <div class="col-md-6 col-sm-6 col-xs-12">          
													...
													<div class="xs-margin"></div>
                                                        ...
                                                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-flag"></i> <span class="input-text">Country &#42;</span></span>
                                                                <div class="large-selectbox clearfix">
                                                                    <select id="shipping_country" name="shipping_country" style="height: 47px; width: 100%; border-color: #dcdcdc;" class="selectbox">
...
$(function (){
	$('select[name="shipping_country"]').change(function(){
		...
		if(country_id != ''){
			...
			$('select[name="shipping_state"]').html('<option value="0">State</option>');
		}
	});
});
</script>  
