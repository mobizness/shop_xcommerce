                                ...
                                <table class="table cart-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>RM <?php echo number_format($orderTax->total, 2);?></td>
                                    ...
                                    <tbody>
                                    	@foreach($orderTax->products as $orderProduct)
                                            <tr>
                                                ...
                                                <td class="item-price-col" style="text-align:right;padding-right:10px">{{ number_format($orderProduct->amount, 2) }}</td>
...
-->
                                        <tr>
                                            ...
                                            <td style="border: none;text-align:right;padding-right:10px">{{ number_format($orderTax->shipping, 2) }}</td>
                                            <td style="border: none;text-align:right;padding-right:10px">{{ number_format($orderTax->shipping * 0.06, 2) }}</td>
                                            <td style="border: none;text-align:right;padding-right:10px">{{ number_format($orderTax->shipping * 1.06, 2) }}</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td style="text-align:right;padding-right:10px"><b>{{ number_format($orderTax->tax + $orderTax->shipping * 0.06, 2) }}</b></td>
                                            <td style="text-align:right;padding-right:10px"><b>{{ number_format($orderTax->total + $orderTax->shipping * 1.06, 2) }}</b></td>
                                        </tr>
                                    </tfoot>
                                </table>
