                                ...
                                <table class="table cart-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>RM <?php echo str_replace('.', '.<span class="sub-price">', number_format($userOrderDetails[0]->totalPrice, 2)) . '</span>';?></td>
                                        ...
                                        <table class="table checkout-table">
                                            ...
                                            @foreach($orderProducts as $orderProduct)
                                                <tr>
                                                    ...
                                                    <td class="item-price-col"><span class="item-price-special">RM <?php echo str_replace('.', '.<span class="sub-price">', number_format($orderProduct->amount, 2)) . '</span>';?></span></td>
                                                    <td>{{ $orderProduct->quantity }}</td>
                                                    <td class="item-total-col"><span class="item-price-special">RM <?php echo str_replace('.', '.<span class="sub-price">', number_format(($orderProduct->quantity * $orderProduct->amount), 2)) . '</span>';?></span></td>
                                                </tr>
                                                <?php
                                            ...
                                            <td class="checkout-table-price">RM <?php echo str_replace('.', '.<span class="sub-price">', number_format($subtotal, 2)) . '</span>';?></td>
                                            </tr>
                                            <tr>
                                            <td class="checkout-table-title" colspan="4">Shipping:</td>
                                            <td class="checkout-table-price">RM <?php echo str_replace('.', '.<span class="sub-price">', number_format($shipping, 2)) . '</span>';?></td>
                                            </tr>
                                            <tr>
                                            <td class="checkout-table-title text-red" colspan="4">Discount:</td>
                                            <td class="checkout-table-price text-red">- RM <?php echo str_replace('.', '.<span class="sub-price">', number_format($userOrderDetails[0]->discount, 2)) . '</span>';?></td>
                                            </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <td class="checkout-total-title" colspan="4"><b>TOTAL:</b></td>
                                                    <td class="checkout-total-price cart-total">RM <?php echo str_replace('.', '.<span class="sub-price">', number_format($userOrderDetails[0]->totalPrice, 2)) . '</span>';?></td>
                                                </tr>
                                            </tfoot>
                                        </table>
	                                    <div class="md-margin"></div>
