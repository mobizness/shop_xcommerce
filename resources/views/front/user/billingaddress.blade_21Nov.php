                ...
                <div class="row">
                	<div class="col-md-12">
						<div class="hero-unit">
                            ...
                            <p>View &amp; edit your billing information.</p>
                        </div>
                        <div class="md-margin2x"></div>
                                        ...
                                        <div class="row">
                                              <div class="col-md-6 col-sm-6 col-xs-12">          
													<div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i> <span class="input-text">First Name &#42;</span></span>
                                                    	<input name="billing_first_name" type="text" class="form-control input-lg" value="<?php echo $userDetail[0]->billing_first_name;?>" required placeholder="Your First Name">
                                                    </div>
                                                        
                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-phone"></i> <span class="input-text">Telephone &#42;</span></span>
                                                    	<input name="billing_telephone" type="text" class="form-control input-lg" value="<?php echo $userDetail[0]->billing_telephone;?>" required placeholder="Your Telephone">
                                                    </div>
                                                 ...
                                                 <div class="col-md-6 col-sm-6 col-xs-12">          
                                                     <div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i> <span class="input-text">Last Name &#42;</span></span>
                                                          <input name="billing_last_name" type="text" class="form-control input-lg" value="<?php echo $userDetail[0]->billing_last_name;?>" required placeholder="Your Last Name">
                                                      </div>

                                                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-envelope"></i> <span class="input-text">Email &#42;</span></span>
                                                          <input name="billing_email" type="text" class="form-control input-lg" value="<?php echo $userDetail[0]->billing_email;?>" required placeholder="Your Email (Login ID)">
                                                       </div>
													...
													<div class="xs-margin"></div>
                                                         <div class="input-group"><span class="input-group-addon"><i class="fa fa-building-o"></i> <span class="input-text">Address &#42;</span></span>
                                                                <textarea name="billing_address" id="contact-message" class="form-control" cols="30" rows="2" placeholder="Your Address"><?php echo $userDetail[0]->billing_address;?></textarea>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <div class="input-group"><span class="input-group-addon"><i class="fa fa-map-marker"></i> <span class="input-text">Post Code &#42;</span></span>
                                                                    <input type="text" name="billing_post_code" class="form-control input-lg" value="<?php echo $userDetail[0]->billing_post_code;?>" required placeholder="Your Post Code">
                                                                </div>
                                                            </div>  
                                                            <!-- end col-md-6 -->                                                    
                                                        </div>
                                                        ...
                                                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-map-marker"></i> <span class="input-text">State &#42;</span></span>
                                                                <div class="large-selectbox clearfix">
                                                                    <select id="billing_state" name="billing_state" style="height: 47px; width: 100%; border-color: #dcdcdc;" class="selectbox">
                                                        ...
                                                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-flag"></i> <span class="input-text">Country &#42;</span></span>
                                                                <div class="large-selectbox clearfix">
                                                                    <select id="billing_country" name="billing_country" style="height: 47px; width: 100%; border-color: #dcdcdc;" class="selectbox">
