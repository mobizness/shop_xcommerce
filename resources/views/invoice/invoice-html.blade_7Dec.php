...
<div style="padding:0px; margin:0px;">
	<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:10px 0; border-top:1px solid #ccc; background:#fff;">
        ...
        <tr>
			...
			<td valign="top" style="border-top:1px solid #ccc;">&nbsp;</td>
			<td align="right" valign="top" style="color:#403e3d; font-size:15px; border-top:1px solid #ccc; padding: 5px 0 0 0;">{{ number_format($gst + 0.06 * $shipping, 2) }}</td>
			<td align="right" valign="top" style="color:#403e3d; font-size:15px; border-top:1px solid #ccc; padding: 5px 0 0 0;">{{ number_format($subtotal + 1.06 * $shipping - $order->discount, 2) }}</td>
        </tr>
        <tr>
			<td colspan="6">&nbsp;</td>
        </tr>
